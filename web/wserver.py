...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://github.com/dakshy/THML"><i class="fab fa-github"></i></a>
...
@app.route('/')
def homepage():
    return "<h1>See mirror-with-weeb <a href='https://github.com/dakshy/THML'>@GitHub</a> By <a href='https://github.com/ToonsHub'>Code With Weeb</a></h1>"
